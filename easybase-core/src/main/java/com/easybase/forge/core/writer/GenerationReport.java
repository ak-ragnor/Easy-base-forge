...
public final class GenerationReport {
	...
	private GenerationReport(List<String> created, List<String> updated, List<String> skipped, List<String> errors) {
	...
	public static final class Builder {
		...
		public Builder created(String path) {
			created.add(path);
			return this;
		}

		public Builder updated(String path) {
			updated.add(path);
			return this;
		}

		public Builder skipped(String path) {
			skipped.add(path);
			return this;
		}
