...
public class GenerateMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        if (report.hasErrors()) {
            throw new MojoExecutionException(
                    "EasyBase generation completed with errors: " + report.errorSummary());
        }
    ...
    private void validateParameters() throws MojoExecutionException {
        if (specFile == null || !specFile.exists()) {
            throw new MojoExecutionException(
                    "specFile not found: " + (specFile != null ? specFile.getAbsolutePath() : "(null)") +
        ...
        if (!configFile.exists()) {
            throw new MojoExecutionException(
                    "easybase-config.yaml not found: " + configFile.getAbsolutePath() +
